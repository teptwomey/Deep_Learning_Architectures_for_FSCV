...
output_directory = f'/mnt/nfs/proj/in-vitro/Tom/dev/trained_models/cf/npd/76_PE/10-F-CV/fold_{fold}/models/{model_params["model_type"]}_wide/' # Reference implementation
