...
# model_params = {
#     "model_type" : "fcn", 
#     "nb_filters" : [128, 256, 512, 256, 128],
#     "filter_szs" : [3, 5, 8, 5, 3],
#     "dropout" : 0,
# }

# simple_tranformer options
# model_params = {
...
# eeg-transformer options
# ~ 425,000 parameters
model_params = {
    "model_type" : "eeg_transformer_reduce",
    "hidden_size" : 290, # Value from eeg transformer paper
    "patch_size" : 9,
    "dropout" : 0.5, # Value from eeg transformer paper
    "head_size" : 10, # I think we want this to be the same as hidden_size?
    "num_heads" : 10, # Value from eeg transformer paper
    "num_layers" : 3, # Value from eeg transformer paper
    "mlp_dim" : 20
}
...
output_directory = f'/mnt/nfs/proj/in-vitro/Tom/dev/trained_models/cf/npd/76_PE/10-F-CV/fold_{fold}/models/{model_params["model_type"]}/'
